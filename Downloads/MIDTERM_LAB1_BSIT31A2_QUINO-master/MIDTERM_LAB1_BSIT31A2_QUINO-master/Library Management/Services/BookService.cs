...
public class BookService
{
    ...
    private readonly ICollection<Domain.BookCopy> _bookCopies = new List<Domain.BookCopy>();
     ...
     private void SeedData()
    {
        ...
        var bookItem1 = new Domain.BookCopy
        {
            Id = Guid.NewGuid(),
        ...
        var bookItem2 = new Domain.BookCopy
        {
            Id = Guid.NewGuid(),
        ...
        foreach (var entry in extraBooks)
        {
            ...
            _bookCopies.Add(new Domain.BookCopy
            {
                Id = Guid.NewGuid(),
    ...
    public void AddBook(Models.AddBookViewModel book)
    {
        ...
        var newAuthor = new Domain.Author
        {
            Id = Guid.NewGuid(),
            Name = book.Author,
        ...
        var newBookItem = new Domain.BookCopy
        {
            Id = Guid.NewGuid(),
    ...
    public IEnumerable<Models.BookListViewModel> GetBooks()
    {
        return _books.Select(b => new Models.BookListViewModel
        {
            BookId = b.Id,
            Title = b.Title,
            ISBN = b.ISBN,
    ...
    public Models.EditBookViewModel GetBookById(Guid id)
    {
        var bookViewModel = GetBooks().FirstOrDefault(b => b.BookId == id) ?? throw new KeyNotFoundException("Book not found");
        var editBookViewModel = new Models.EditBookViewModel
        {
   ...
   public void AddCopy(Guid bookId)
    {
        ...
        var newCopy = new Domain.BookCopy
        {
            Id = Guid.NewGuid(),
            Book = book,
            AddedDate = DateTime.Now,
    ...
    {
        return _bookCopies.FirstOrDefault(bc => bc.Id == copyId);
    }
